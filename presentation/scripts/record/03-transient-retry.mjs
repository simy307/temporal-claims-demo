...
import { record, createClaim, waitForClaim, setAdjuster, pause, smoothScrollTo, WEB_BASE } from '../record-helpers.mjs';
...
await record('03-transient-retry', async (page) => {
  ...
  await smoothScrollTo(page, page.getByText('Activity execution & retries'));
